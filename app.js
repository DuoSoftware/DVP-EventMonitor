                    ...
                    redisClient.get('SIPUSER_RESOURCE_MAP:' + tenantId + ':' + companyId + ':' + callerOrigIdName, function(err, objString)
                    {
                        ...
                        if(obj && obj.Context)
                        {
                            ...
                            if(actionCat === 'DIALER')
                            {
                                ...
                                nsObj.Message = 'agent_found|' + uniqueId + '|INBOUND|' + evtObj['Caller-Caller-ID-Number'] + '|' + evtObj['Caller-Caller-ID-Number'] + '|' + evtObj['Caller-Destination-Number'] + '|INBOUND|inbound|call|undefined|' + otherlegUniqueId;
                    ...
                    if(direction === 'outbound' && dvpCallDirection === 'outbound' && companyId && tenantId)
                    {
                        ...
                        redisClient.get('SIPUSER_RESOURCE_MAP:' + tenantId + ':' + companyId + ':' + callerOrigIdName, function(err, objString)
                        {
                            ...
                            if(obj && obj.Context)
                            {
                                ...
                                if(actionCat === 'DIALER')
                                {
                                    nsObj.Message = 'agent_connected|' + uniqueId + '|INBOUND|' + evtObj['Caller-Caller-ID-Number'] + '|' + evtObj['Caller-Caller-ID-Number'] + '|' + evtObj['Caller-Destination-Number'] + '|INBOUND|inbound|call|undefined|' + otherlegUniqueId;
                        ...
                        redisClient.get('SIPUSER_RESOURCE_MAP:' + tenantId + ':' + companyId + ':' + callerOrigIdName, function(err, objString)
                        {
                            ...
                            if(obj && obj.Context)
                            {
                                var nsObj = {
                                    ...
                                    From: 'CALLSERVER',
                                    Callback: '',
                                    Message: 'agent_disconnected|' + uniqueId + '|INBOUND|' + evtObj['Caller-Caller-ID-Number'] + '|' + evtObj['Caller-Caller-ID-Number'] + '|' + evtObj['Caller-Destination-Number'] + '|INBOUND|inbound|call|undefined|' + otherLegUniqueId
                                };
